# -*- coding: utf-8 -*-
# @Author: watcher
# @Created Time: 2023/3/24 2:07 PM
# @File: textrnn_classifier
...
from EasyAI.TextClassifier.data_helper import set_seed, load_vocab
from .data import build_dataset, build_iterator
from .models import TextRNNAttModel
